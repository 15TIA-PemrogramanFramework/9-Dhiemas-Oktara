					...
					<div class="panel-body">
						...
						<form role="form" class="form-horizontal form-groups-bordered" action="<?php echo $action; ?>" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" placeholder="Masukkan Nama Pemilik" value="<?php echo $nama_pemilik ?>" class="form-control" name="nama_pemilik">
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="submit" class="btn btn-default">Simpan</button><input type="hidden" name="id" value="<?php echo $id_pemilik ?>">
								</div>
							</div>
